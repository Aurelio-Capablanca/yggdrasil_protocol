...
//     //binary operations
//     Convert(Box<Operator<T>>, Box<Operator<T>>),
//     PlusB(Box<Operator<T>>, Box<Operator<T>>),
//     MinusB(Box<Operator<T>>, Box<Operator<T>>),
//     DivideB(Box<Operator<T>>, Box<Operator<T>>),
//     MultiplyB(Box<Operator<T>>, Box<Operator<T>>)
// }
